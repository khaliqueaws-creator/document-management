...
def retrieve_question_context(question, top_k=None):
...
def generate_answer_with_bedrock(prompt):
    ...
    try:
        return parse_bedrock_response_text(payload)
...
def answer_question(question):
    ...
    contexts = retrieve_question_context(question)

    if not contexts:
        return {
            "answer": (
                "The available documents do not contain enough relevant "
