...
AI_RAG_CONVERSATION_MAX_TURNS = int(
    os.environ.get("AI_RAG_CONVERSATION_MAX_TURNS", "5")
)
AI_RAG_CONVERSATION_MAX_CHARS = int(
    os.environ.get("AI_RAG_CONVERSATION_MAX_CHARS", "4000")
)
